About pyseidon-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyseidon-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4143&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyseidon-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyseidon` can be installed with `conda`:
...
```
mamba install pyseidon
```

It is possible to list all of the versions of `pyseidon` available on your platform with `conda`:
...
```
mamba search pyseidon --channel conda-forge
```
...
mamba repoquery search pyseidon --channel conda-forge

# List packages depending on `pyseidon`:
mamba repoquery whoneeds pyseidon --channel conda-forge

# List dependencies of `pyseidon`:
mamba repoquery depends pyseidon --channel conda-forge
```
...
* [@GrumpyNounours](https://github.com/GrumpyNounours/)
